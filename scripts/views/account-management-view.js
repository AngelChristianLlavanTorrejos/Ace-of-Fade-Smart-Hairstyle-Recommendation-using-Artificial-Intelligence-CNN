export const accountManagementView = {
  ...
  labels: [
    'User ID', 'Role', 'First Name', 'Middle Name', 'Last Name',
  ...
  createDataDiv(value) {
    ...
    if (value === null || value === undefined || value === '') {
      ...
      dataDiv.className = 'text-danger w-75';
    } else {
      dataDiv.textContent = value;
      dataDiv.className = 'text-dark w-75';
    }
  ...
  async renderPersonalInformation(data) {
    ...
    this.labels.forEach(labelText => {
      ...
      const label = this.createLabel('text-dark w-25', labelText);
  ...
  createInput(label, value) {
    ...
    'User ID', 'First Name', 'Last Name', 'Role', 'Registration Date', 'Email'
    ];
    ...
    input.className = 'form-control text-dark mb-3';
    input.value = value;
  ...
  async renderUpdate (data) {
    ...
    this.labels.forEach(labelText => {
      ...
      const label = this.createLabel('text-dark', labelText);
  ...
  async renderChangePassword() {
    ...
    labels.forEach((labelText, index) => {
        ...
        label.className = 'text-dark w-25'
        
        const input = document.createElement('input');
        input.className = 'form-control text-dark w-75';
        input.name = name;
        input.type = 'password';
